  ...
  <div>
      ...
      >
        ...
        >
          <p class="uppercase tracking-loose w-full">
            Travel Expert in Saudi Arabia
          </p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Life is Short and The World is Wilde!
          </h1>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        International Flights and Luxurious Hootels
      </h3>
      <button
        class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
      >
      ...
      <div class="container mx-auto px-8">
        <div class="w-full flex flex-col md:flex-row py-6">
          <div class="flex-1 mb-6 text-black">
            <a
              class="text-yellow-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
              href="#"
            >
              <!--Icon from: http://www.potlabicons.com/ -->
              <svg
          ...
          <div>  الطائر الذهبي للرحلات الجوية <br>   رقم الترخيص :73100878 </div>
        </div>
      </div>
    </footer>
  </div>
